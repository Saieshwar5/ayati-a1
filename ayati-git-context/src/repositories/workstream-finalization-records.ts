...
export function insertWorkstreamFinalization(database: ContextDatabase, input: {
  ...
  database.prepare([
    ...
    "run_id, operation_request_id, lease_id, session_id, workstream_id, bound_request_id,",
    "conversation_id, phase, outcome, stop_reason, validation, summary, next_action, completion_json,",
    "assistant_response, base_head, conversation_hash, plan_json, resource_events_json, commit_head,",
...
function select(): string {
  return [
    "SELECT run_id, operation_request_id, lease_id, session_id, workstream_id, bound_request_id,",
    "conversation_id, phase, outcome, stop_reason, validation, summary, next_action, completion_json,",
    "assistant_response, base_head, conversation_hash, plan_json, resource_events_json, commit_head,",
