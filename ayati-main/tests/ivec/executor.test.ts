...
describe("executeStep", () => {
  ...
  it("executes reason → act → verify and writes step files", async () => {
    ...
    try {
      ...
      const provider: LlmProvider = {
        ...
        generateTurn: vi.fn().mockImplementation(async () => {
          ...
          if (callCount === 1) {
            ...
            return {
              ...
              content: JSON.stringify({
                thinking: "I should run the command",
          ...
          // verify phase (shouldn't reach — gate should handle it)
      ...
      expect(existsSync(join(runPath, "steps", "001-reason.json"))).toBe(true);
