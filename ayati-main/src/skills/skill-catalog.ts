...
const DEFAULT_SKILL_CARDS: Record<string, Partial<SkillCard>> = {
  ...
  attachments: {
    title: "Attachments",
    summary: "Restore prepared attachment context into the current run.",
    domains: ["attachments"],
    triggers: ["attachment", "upload", "attached", "file context"],
    whenToUse: "Use when the current task depends on uploaded or previously prepared attachments.",
  ...
  files: {
    title: "Managed Files",
    summary: "Inspect, register, read, query, and profile managed uploaded files/directories.",
    domains: ["files", "attachments"],
    triggers: ["attached file", "managed file", "upload", "directory attachment", "file query"],
    whenToUse: "Use for uploaded files/directories and managed file-library records.",
