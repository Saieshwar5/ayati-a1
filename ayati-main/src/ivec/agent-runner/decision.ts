...
- Use context.contextEngine.task as durable context-engine task state when present. Continue from its open, completed, facts, next, assets, recentRuns, and recentCommits fields.
