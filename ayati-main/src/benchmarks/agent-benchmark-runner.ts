              ...
              action: {
                ...
                calls: [{
                  ...
                  input: {
                    files: [{
                      path: targetPath,
                      patches: [{ kind: "replace_text", find: "status: draft", replace: "status: ready" }],
                    }],
                  },
                  dependsOn: [],
                  purpose: "Update the status line",
                }],
                allowedTools: ["patch_files"],
              },
            },
                  ...
                  },
                  {
                    ...
                    input: {
                      files: [{
                        ...
                        baseSha256: await hashFile(sourcePath),
                      }],
                    },
        ...
        providerResponses: [
          {
            decision: {
              ...
              action: {
                ...
                calls: [
                  {
                    id: "read_calculator_files",
                    tool: "read_files",
                    input: { files: [{ path: sourcePath }, { path: testPath }] },
                    dependsOn: [],
                    purpose: "Inspect calculator implementation style and tests",
                  },
                ],
                  ...
                  },
                  {
                    ...
                    input: {
                      files: [{
                        ...
                        baseSha256: await hashFile(testPath),
                      }],
                    },
        ...
        providerResponses: [
          {
            decision: {
              ...
              action: {
                mode: "sequential",
                calls: [
                  { id: "read_sync", tool: "read_files", input: { files: [{ path: syncPath }] }, dependsOn: [], purpose: "Inspect sync cache" },
                  {
                    id: "write_sync",
                    tool: "write_files",
                    input: { files: [{ path: syncPath, content: syncCacheWithTtlSource(), baseSha256: await hashFile(syncPath) }] },
                    dependsOn: ["read_sync"],
        ...
        providerResponses: [
          {
            decision: {
              ...
              action: {
                mode: "sequential",
                calls: [
                  { id: "read_async", tool: "read_files", input: { files: [{ path: asyncPath }] }, dependsOn: [], purpose: "Inspect async cache" },
                  {
                    id: "write_async",
                    tool: "write_files",
                    input: { files: [{ path: asyncPath, content: asyncCacheWithTtlSource(), baseSha256: await hashFile(asyncPath) }] },
            ...
            decision: {
              ...
              action: {
                ...
                calls: [{
                  id: "write_summary",
                  tool: "write_files",
                  input: { files: [{ path: targetPath, content: "Fixture project summary: missing directory recovery benchmark.\n" }] },
                  dependsOn: [],
