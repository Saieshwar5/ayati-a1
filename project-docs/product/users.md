...
Primary users are people who want a persistent AI helper that can assist with real-life tasks through their computer. Developers and power users are important early users, but Ayati is not only a coding assistant.

The intended user experience is closer to a personal agent than a chatbot. The agent should remember useful facts, understand user preferences, respond through available communication channels, and use computer access carefully to do useful work.
